...
interface ConsumerStrategy {
    ...
    fun serialize(source: CwpVoteContext): String
    fun deserialize(value: String, target: CwpVoteContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: CwpVoteProcessor = CwpVoteProcessor(),
    ...
    private fun sendResponse(context: CwpVoteContext, strategy: ConsumerStrategy, outputTopic: String) {
